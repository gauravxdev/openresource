...
export async function createAdminResource(data: z.infer<typeof resourceSchema>) {
    try {
...
export async function updateAdminResource(id: string, data: Partial<z.infer<typeof resourceSchema>>) {
    try {
