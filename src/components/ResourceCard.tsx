...
const BookmarkButton = dynamic(() =>
  import("@/components/BookmarkButton").then((m) => m.BookmarkButton),
);
...
export function ResourceCard({ resource }: ResourceCardProps) {
  ...
  return (
    ...
    >
      <Card
        className="group border-neutral-150 relative flex h-full flex-col gap-0 overflow-hidden rounded-[12px] border bg-transparent p-0 transition-all duration-200 hover:outline-[3px] hover:outline-neutral-200 dark:border-neutral-800 dark:hover:outline-neutral-800"
        style={{
        ...
        <CardContent className="relative flex h-full flex-col p-4">
          ...
          <div className="relative mt-2 flex-1 overflow-hidden">
            ...
            <div className="pointer-events-none absolute inset-x-0 top-0 flex h-full translate-y-4 flex-col bg-transparent opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
              <div className="flex-1">
                <p className="dark:text-muted-foreground line-clamp-5 text-[0.95rem] leading-relaxed text-neutral-600">
