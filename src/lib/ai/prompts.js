 ...
 */
function isGoalClear(projectGoal) {
 ...
 */
function getConfidenceLevel(signals) {
 ...
 */
function buildOpeningInstruction(signals, confidence) {
    const lines = [];
 ...
 */
function buildFactsSection(signals) {
    const lines = [];
