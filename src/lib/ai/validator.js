 ...
 */
function findMentionedTechnologies(text, techStack) {
    ...
    for (const match of allMatches) {
        ...
        const isInStack = normalizedStack.some((stackTech) => stackTech.includes(match) || match.includes(stackTech));
        if (!isInStack) {
