 ...
 */
function buildTechStack(languages) {
 ...
 */
function buildProjectGoal(description, readme) {
    // 1. Repo description
 ...
 */
function buildMaintenance(updatedAt) {
    if (!updatedAt)
        return "inactive";
 ...
 */
function buildMaturity(releaseCount) {
 ...
 */
export function buildRepoSignals(input) {
