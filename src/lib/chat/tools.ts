...
const exaParameters = z.object({
    query: z.string().optional().describe("The search query to execute on Exa. You MUST always provide this parameter."),
    type: z.enum(["auto", "keyword", "neural"]).default("auto").describe("The type of search algorithm to use. 'auto' is usually best."),
});

export const exaSearch = tool({
    description: "Search the web for information using the Exa API. Best for finding specific sources, neural/semantic search, and deep dives. IMPORTANT: You MUST provide the 'query' parameter as a string.",
...
const tavilyParameters = z.object({
    query: z.string().optional().describe("The search query to execute on Tavily. You MUST always provide this parameter."),
});

export const tavilySearch = tool({
    description: "Search the web for real-time information and comprehensive answers using the Tavily API. Best for quick answers, news, and research. IMPORTANT: You MUST provide the 'query' parameter as a string.",
...
const serperParameters = z.object({
    query: z.string().optional().describe("The search query to execute on Google. You MUST always provide this parameter."),
});

export const serperSearch = tool({
    description: "Search Google using the Serper API. Best for standard keyword searches, factual lookups, or when you need traditional Google results. IMPORTANT: You MUST provide the 'query' parameter as a string.",
